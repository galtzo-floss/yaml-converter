...
Gem::Specification.new do |spec|
  ...
  spec.metadata["homepage_uri"] = "https://yaml-converter.galtzo.com"
  ...
  # kettle-jem:freeze
  # To retain chunks of comments & code during yaml-converter templating:
  # Wrap custom sections with freeze markers (e.g., as above and below this comment chunk).
  # yaml-converter will then preserve content between those markers across template runs.
  # kettle-jem:unfreeze

  spec.require_paths = ["lib"]

  # Utilities
  spec.add_dependency("hexapdf", ">= 1.8", "< 2")           # Native PDF rendering (Phase 2)
  ...
  spec.add_development_dependency("kettle-dev", "~> 2.2", ">= 2.2.9")      # ruby >= 3.2.0
  ...
  # The 'git' gem is optional; yaml-converter falls back to shelling out to `git` if it is not present.
